...
## Student: surge
## Date: Jul 14, 2022
## Problem Set 4: The 6.00 Word Game (PART B)
''' 
...
def playGame(wordList):
    ...
    while play_game != 'e':
        ...
        if play_game == 'n':
            ...
            while True:
                # (New) Choose Computer or User
                play_type = input("Enter u to have yourself play, c to have the computer play: ")
        ...
        # Replay Last Hand
            ...
            try:
                ...
                while True:
                    # (Replay) Choose Computer or User
                    play_type = input("Enter u to have yourself play, c to have the computer play: ")
