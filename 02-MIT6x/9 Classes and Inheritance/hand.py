...
## Exercise: hand
''' 
In this proble, you'll be ased to read through an object-oriented implementaiton of the hand from the word game problem
from PSET 4. You will be ased to implement one of its methods using OOP, instead of using the functional implementation.

Read through the below file.
Implement the `udate` method
Paste the entire Hand class into the submission box.

Use the provided str method to submit for grading.
'''
########################################################################################################################
